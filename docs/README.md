...
Implementation guides for the Magical Mixing Console codebase.

## New to the repo

1. [development/DEVELOPMENT.md](./development/DEVELOPMENT.md) — clone, plugins, npm scripts
2. [TESTING.md](./TESTING.md) — automated tests (Vitest)
3. [reference/ARCHITECTURE.md](./reference/ARCHITECTURE.md) — layers and where to change code
4. [reference/CONCEPTS.md](./reference/CONCEPTS.md) — mixer domain model
...
| Document | Purpose |
|----------|---------|
| [reference/ARCHITECTURE.md](./reference/ARCHITECTURE.md) | Code layers and problem routing |
| [reference/CONCEPTS.md](./reference/CONCEPTS.md) | Mixer domain model |
