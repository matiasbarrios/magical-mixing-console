...
import { useBusGateHold, useDevice } from '@magical-mixing/mixers-react';
...
import { always3Numbers } from '../../../../../helpers/format';
            ...
            {isValidValue && (
                <Flex direction="column" align="center" justify="center" gapY="1">
                    <Knob
                        ...
                        maximum={maximum}
                        onRightClick={doOpen}
                        ariaLabel={t('Hold', undefined, true)}
                        disabled={disabled}
                        decimalsToShow={0}
                        asButton
                        resetValue={minimum}
                        onFocusScale={1.5}
                        formatValue={always3Numbers}
                    />
                </Flex>
            )}
