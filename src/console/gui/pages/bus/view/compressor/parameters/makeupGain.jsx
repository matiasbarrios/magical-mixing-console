...
import { useBusCompressorGain, useDevice } from '@magical-mixing/mixers-react';
            ...
            {isValidValue && (
                <Flex direction="column" align="center" justify="center" gapY="1">
                    <Knob
                        ...
                        maximum={maximum}
                        onRightClick={doOpen}
                        ariaLabel={t('Makeup gain', undefined, true)}
                        disabled={disabled}
                        decimalsToShow={1}
                        asButton
                        resetValue={minimum}
