...
import { useBusCompressorOn, useBusCompressorReset, useDevice } from '@magical-mixing/mixers-react';
...
// Internal
const On = ({ busId }) => {
    const { has, value, toggle } = useBusCompressorOn(busId);
...
const Reset = ({ busId }) => {
    ...
    const { reset } = useBusCompressorReset(busId);
