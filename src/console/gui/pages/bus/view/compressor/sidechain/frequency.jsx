...
import { useBusCompressorSidechainFrequency, useDevice } from '@magical-mixing/mixers-react';
...
export default ({ busId }) => {
    ...
    } = useBusCompressorSidechainFrequency(busId);
            ...
            {isValidValue && (
                <Flex direction="column" align="center" justify="center" gapY="1">
                    <Knob
                        ...
                        maximum={maximum}
                        onRightClick={doOpen}
                        ariaLabel={t('High cut', undefined, true)}
                        disabled={disabled}
                        decimalsToShow={0}
                        asButton
                        resetValue={minimum}
